...
async function loadUserGrievances() {
    ...
    try {
        ...
        const result =
            await API.Grievance.getMyGrievances();
...
// old pages calling loadGrievances() will work now
window.loadGrievances = loadUserGrievances;
...
async function loadGrievanceDetail() {
    ...
    try {
        ...
        const result =
            await API.Grievance.getById(id);
...
function renderGrievanceDetail(g) {
    ...
    document.getElementById('grievanceId').textContent =
        g.grievance_id;
    ...
    document.getElementById('grievanceCategory').textContent =
        g.category_name || '-';

    document.getElementById('grievanceLocation').textContent =
        g.location_details || '-';

    document.getElementById('grievanceText').textContent =
        g.complaint_text;
